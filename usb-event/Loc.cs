...
sealed class LocStrings
{
    ...
    public required string TrayDeprecated { get; init; }
    ...
    public required string LabelStartOnPlugIn { get; init; }
    public required string LabelKillOnPlugOut { get; init; }
    public required string LabelStartOnStart  { get; init; }
...
static class Loc
{
    ...
    static LocStrings En => new()
    {
        ...
        TrayDeprecated = "⚠ --tray is deprecated; tray mode is now the default.",
        ...
        LabelArgs = "Arguments:",
        LabelStartOnPlugIn = "Start on plug in",
        LabelKillOnPlugOut = "Kill on plug out",
        LabelStartOnStart  = "Start on app start (if connected)",
    ...
    static LocStrings De => new()
    {
        ...
        TrayDeprecated = "⚠ --tray ist veraltet; der Tray-Modus ist jetzt Standard.",
        ...
        LabelArgs = "Argumente:",
        LabelStartOnPlugIn = "Starten beim Einstecken",
        LabelKillOnPlugOut = "Beenden beim Abziehen",
        LabelStartOnStart  = "Beim Programmstart starten (falls verbunden)",
    ...
    static LocStrings Fr => new()
    {
        ...
        TrayDeprecated = "⚠ --tray est obsolète ; le mode barre des tâches est désormais celui par défaut.",
        ...
        LabelArgs = "Arguments :",
        LabelStartOnPlugIn = "Démarrer à la connexion",
        LabelKillOnPlugOut = "Arrêter à la déconnexion",
        LabelStartOnStart  = "Démarrer au lancement (si connecté)",
    ...
    static LocStrings Es => new()
    {
        ...
        TrayDeprecated = "⚠ --tray está obsoleto; el modo de bandeja es ahora el predeterminado.",
        ...
        LabelStartOnPlugIn = "Iniciar al conectar",
        LabelKillOnPlugOut = "Terminar al desconectar",
        LabelStartOnStart  = "Iniciar al arrancar (si conectado)",
    ...
    static LocStrings Ru => new()
    {
        ...
        TrayDeprecated = "⚠ --tray устарел; режим трея теперь используется по умолчанию.",
        ...
        LabelArgs = "Аргументы:",
        LabelStartOnPlugIn = "Запускать при подключении",
        LabelKillOnPlugOut = "Завершать при отключении",
        LabelStartOnStart  = "Запускать при старте (если подключено)",
    ...
    static LocStrings Ja => new()
    {
        ...
        TrayDeprecated = "⚠ --tray は非推奨です。トレイモードがデフォルトになりました。",
        ...
        LabelProgram = "実行ファイル:",
        LabelArgs = "引数:",
        LabelStartOnPlugIn = "接続時に起動",
        LabelKillOnPlugOut = "切断時に終了",
        LabelStartOnStart  = "起動時に開始（接続中の場合）",
    ...
    static LocStrings Zh => new()
    {
        ...
        TrayDeprecated = "⚠ --tray 已弃用；托盘模式现在是默认模式。",
        ...
        LabelProgram = "可执行文件:",
        LabelArgs = "参数:",
        LabelStartOnPlugIn = "插入时启动",
        LabelKillOnPlugOut = "拔出时终止",
        LabelStartOnStart  = "启动时开始（如已连接）",
    ...
    static LocStrings Ar => new()
    {
        ...
        TrayDeprecated = "⚠ --tray مهمل؛ وضع شريط المهام أصبح الافتراضي.",
        ...
        LabelArgs = "المعطيات:",
        LabelStartOnPlugIn = "بدء عند التوصيل",
        LabelKillOnPlugOut = "إيقاف عند الفصل",
        LabelStartOnStart  = "بدء عند تشغيل التطبيق (إذا كان متصلاً)",
    ...
    static LocStrings Id => new()
    {
        ...
        TrayDeprecated = "⚠ --tray sudah usang; mode tray kini menjadi default.",
        ...
        LabelArgs = "Argumen:",
        LabelStartOnPlugIn = "Mulai saat terpasang",
        LabelKillOnPlugOut = "Hentikan saat dicabut",
        LabelStartOnStart  = "Mulai saat aplikasi dimulai (jika terhubung)",
    ...
    static LocStrings Ko => new()
    {
        ...
        TrayDeprecated = "⚠ --tray는 더 이상 사용되지 않습니다. 트레이 모드가 이제 기본값입니다.",
        ...
        LabelProgram = "실행 파일:",
        LabelArgs = "인수:",
        LabelStartOnPlugIn = "연결 시 시작",
        LabelKillOnPlugOut = "분리 시 종료",
        LabelStartOnStart  = "앱 시작 시 실행 (연결된 경우)",
    ...
    static LocStrings Pt => new()
    {
        ...
        TrayDeprecated = "⚠ --tray está obsoleto; o modo de bandeja agora é o padrão.",
        ...
        LabelArgs = "Argumentos:",
        LabelStartOnPlugIn = "Iniciar ao conectar",
        LabelKillOnPlugOut = "Encerrar ao desconectar",
        LabelStartOnStart  = "Iniciar ao abrir o app (se conectado)",
    ...
    static LocStrings Hi => new()
    {
        ...
        TrayDeprecated = "⚠ --tray पुराना हो गया है; ट्रे मोड अब डिफ़ॉल्ट है।",
        ...
        LabelArgs = "तर्क:",
        LabelStartOnPlugIn = "कनेक्ट होने पर शुरू करें",
        LabelKillOnPlugOut = "डिसकनेक्ट होने पर बंद करें",
        LabelStartOnStart  = "ऐप स्टार्ट पर शुरू करें (यदि कनेक्टेड हो)",
    ...
    static LocStrings Sv => new()
    {
        ...
        TrayDeprecated = "⚠ --tray är föråldrat; fältläget är nu standard.",
        ...
        LabelArgs = "Argument:",
        LabelStartOnPlugIn = "Starta vid anslutning",
        LabelKillOnPlugOut = "Avsluta vid frånkoppling",
        LabelStartOnStart  = "Starta vid appstart (om ansluten)",
    ...
    static LocStrings No => new()
    {
        ...
        TrayDeprecated = "⚠ --tray er utdatert; systemfeltet er nå standard.",
        ...
        LabelStartOnPlugIn = "Start ved tilkobling",
        LabelKillOnPlugOut = "Avslutt ved frakobling",
        LabelStartOnStart  = "Start ved oppstart (hvis tilkoblet)",
    ...
    static LocStrings Fi => new()
    {
        ...
        TrayDeprecated = "⚠ --tray on vanhentunut; lokeromoodi on nyt oletusarvo.",
        ...
        LabelStartOnPlugIn = "Käynnistä kytkettäessä",
        LabelKillOnPlugOut = "Lopeta irrotettaessa",
        LabelStartOnStart  = "Käynnistä sovelluksen käynnistyessä (jos yhdistetty)",
    ...
    static LocStrings Et => new()
    {
        ...
        TrayDeprecated = "⚠ --tray on aegunud; sahtlirežiim on nüüd vaikimisi.",
        ...
        LabelStartOnPlugIn = "Käivita ühendamisel",
        LabelKillOnPlugOut = "Lõpeta lahutamisel",
        LabelStartOnStart  = "Käivita rakenduse käivitumisel (kui ühendatud)",
    ...
    static LocStrings Lv => new()
    {
        ...
        TrayDeprecated = "⚠ --tray ir novecojis; teknes režīms tagad ir noklusējums.",
        ...
        LabelArgs = "Argumenti:",
        LabelStartOnPlugIn = "Startēt pievienojot",
        LabelKillOnPlugOut = "Pārtraukt atvienojot",
        LabelStartOnStart  = "Startēt lietotnes palaišanā (ja pievienots)",
    ...
    static LocStrings Lt => new()
    {
        ...
        TrayDeprecated = "⚠ --tray yra pasenusi; dėklo režimas dabar yra numatytasis.",
        ...
        LabelStartOnPlugIn = "Paleisti prijungus",
        LabelKillOnPlugOut = "Sustabdyti atjungus",
        LabelStartOnStart  = "Paleisti paleidžiant programą (jei prijungta)",
    ...
    static LocStrings Pl => new()
    {
        ...
        TrayDeprecated = "⚠ --tray jest przestarzałe; tryb zasobnika jest teraz domyślny.",
        ...
        LabelArgs = "Argumenty:",
        LabelStartOnPlugIn = "Uruchom po podłączeniu",
        LabelKillOnPlugOut = "Zakończ po odłączeniu",
        LabelStartOnStart  = "Uruchom przy starcie aplikacji (jeśli podłączono)",
    ...
    static LocStrings Cs => new()
    {
        ...
        TrayDeprecated = "⚠ --tray je zastaralé; režim lišty je nyní výchozí.",
        ...
        LabelArgs = "Argumenty:",
        LabelStartOnPlugIn = "Spustit při připojení",
        LabelKillOnPlugOut = "Ukončit při odpojení",
        LabelStartOnStart  = "Spustit při startu aplikace (je-li připojeno)",
    ...
    static LocStrings Hr => new()
    {
        ...
        TrayDeprecated = "⚠ --tray je zastarjelo; način rada trake sada je zadani.",
        ...
        LabelArgs = "Argumenti:",
        LabelStartOnPlugIn = "Pokreni pri spajanju",
        LabelKillOnPlugOut = "Zaustavi pri odvajanju",
        LabelStartOnStart  = "Pokreni pri pokretanju aplikacije (ako je spojeno)",
    ...
    static LocStrings Sq => new()
    {
        ...
        TrayDeprecated = "⚠ --tray është i vjetruar; modaliteti i shiritit tani është parazgjedhja.",
        ...
        LabelStartOnPlugIn = "Nis gjatë lidhjes",
        LabelKillOnPlugOut = "Ndal gjatë shkëputjes",
        LabelStartOnStart  = "Nis gjatë nisjes së aplikacionit (nëse i lidhur)",
