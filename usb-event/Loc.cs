...
static class Loc
{
    ...
    static LocStrings En => new()
    {
        ...
        LabelStartOnStart = "Start on start",
    ...
    static LocStrings De => new()
    {
        ...
        LabelStartOnStart = "Beim Start starten",
    ...
    static LocStrings Fr => new()
    {
        ...
        LabelStartOnStart = "Démarrer au lancement",
    ...
    static LocStrings Es => new()
    {
        ...
        LabelStartOnStart = "Iniciar al arrancar",
    ...
    static LocStrings Ru => new()
    {
        ...
        LabelStartOnStart = "Запустить при старте",
    ...
    static LocStrings Ar => new()
    {
        ...
        LabelStartOnStart = "تشغيل عند البدء",
    ...
    static LocStrings Id => new()
    {
        ...
        LabelStartOnStart = "Mulai saat start",
    ...
    static LocStrings Pt => new()
    {
        ...
        LabelStartOnStart = "Iniciar na inicialização",
    ...
    static LocStrings Hi => new()
    {
        ...
        LabelStartOnStart = "प्रारंभ पर शुरू करें",
    ...
    static LocStrings Sv => new()
    {
        ...
        LabelStartOnStart = "Starta vid uppstart",
    ...
    static LocStrings No => new()
    {
        ...
        LabelStartOnStart = "Start ved oppstart",
    ...
    static LocStrings Fi => new()
    {
        ...
        LabelStartOnStart = "Käynnistä alussa",
    ...
    static LocStrings Et => new()
    {
        ...
        LabelStartOnStart = "Käivita käivitusel",
    ...
    static LocStrings Lv => new()
    {
        ...
        LabelStartOnStart = "Sākt pie palaišanas",
    ...
    static LocStrings Lt => new()
    {
        ...
        LabelStartOnStart = "Paleisti paleidžiant",
    ...
    static LocStrings Pl => new()
    {
        ...
        LabelStartOnStart = "Uruchom przy starcie",
    ...
    static LocStrings Cs => new()
    {
        ...
        LabelStartOnStart = "Spustit při startu",
    ...
    static LocStrings Hr => new()
    {
        ...
        LabelStartOnStart = "Pokreni pri pokretanju",
    ...
    static LocStrings Sq => new()
    {
        ...
        LabelStartOnStart = "Nis në fillim",
